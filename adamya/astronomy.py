...
class AstronomyEngine:
    ...
    def calculate(
        ...
        # Astronomical night begins once the
        # Sun is below -18°, while this app
        # uses -6° as a simple "dark enough"
        # observing threshold.
        dark_enough = (
            sun_altitude < -6
        )
        ...
        for (
            ...
            # Basic "good observing target"
            # definition for this hackathon.
            visible = (
                altitude_deg > 5
                and (
                    object_type == "sun"
            ...
            # Moon can still be useful before
            # full darkness as long as it is up.
            if (
                object_type == "moon"
                and altitude_deg > 5
                and sun_altitude < 0
    ...
    def _solar_events(
        ...
        # Search a 2-day window so events around
        # midnight are still available.
        search_start = (
            local_midnight
            - timedelta(days=1)
        )
        ...
        # Fallbacks only used if the astronomical
        # calculation cannot produce an event.
        sunset = (
            local_midnight
            + timedelta(hours=18)
        )
